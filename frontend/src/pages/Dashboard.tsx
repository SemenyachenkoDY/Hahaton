...
export default function Dashboard() {
  ...
  useEffect(() => {
    setLoading(true);
    Promise.all([fetchDashboardStats(), fetchSchools()])
    ...
    >
        ...
        >
          <div
            ...
            style={{
              ...
              borderRadius: "32px",
              boxShadow: "0 50px 100px rgba(255, 102, 0, 0.15)",
              position: "relative",
              display: "flex",
              flexDirection: "column",
              gap: "25px",
          ...
          >
            ...
            <div>
              ...
              <p style={{ color: "#666" }}>
                Выберите необходимые фильтры для выгрузки XLSX файла
              </p>
            </div>
      ...
      >
        <div>
          ...
          <p style={{ color: "#666" }}>
            Интерактивный мониторинг процедур независимого тестирования
          </p>
        </div>
        <button
      ...
      >
        ...
        >
          <div>
            ...
            <div
              style={{ fontSize: "2.5rem", fontWeight: 900, color: "#121212" }}
            >
              {stats?.total_tests || 0}
            </div>
          </div>
      ...
      >
        <div className="liquid-glass" style={{ padding: "25px" }}>
          ...
          >
            <BarChart3 size={20} color="#ff6600" /> Активность организаций
            (Топ-10)
          </h3>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart
              data={stats?.school_activity || []}
              layout="vertical"
              margin={{ left: 40 }}
            >
              <CartesianGrid
      ...
      >
        ...
        >
          ...
          >
            <PieIcon size={18} color="#10b981" style={{ marginRight: "8px" }} />{" "}
            Результаты
          </h3>
